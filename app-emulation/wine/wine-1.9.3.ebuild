...
if [[ ${PV} == "9999" ]] ; then
	...
	MY_P="${PN}-${PV/_/-}"
	SRC_URI="http://dl.winehq.org/${PN}/source/${PV:0:3}/${MY_P}.tar.bz2"
...
SRC_URI="${SRC_URI}
	gecko? (
		abi_x86_32? ( http://dl.winehq.org/${PN}/wine-gecko/${GV}/wine_gecko-${GV}-x86.msi )
		abi_x86_64? ( http://dl.winehq.org/${PN}/wine-gecko/${GV}/wine_gecko-${GV}-x86_64.msi )
	)
	mono? ( http://dl.winehq.org/${PN}/wine-mono/${MV}/wine-mono-${MV}.msi )
...
if [[ ${PV} == "9999" ]] ; then
	...
	SRC_URI="${SRC_URI}
	staging? ( https://github.com/wine-compholio/wine-staging/archive/v${PV/_/-}.tar.gz -> ${STAGING_P}.tar.gz )
	pulseaudio? ( https://github.com/wine-compholio/wine-staging/archive/v${PV/_/-}.tar.gz -> ${STAGING_P}.tar.gz )"
fi
