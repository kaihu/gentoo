...
# $Header: /var/cvsroot/gentoo-x86/app-accessibility/speech-tools/speech-tools-2.1-r1.ebuild,v 1.6 2011/09/24 16:34:10 armin76 Exp $
...
DEPEND="esd? ( media-sound/esound )
	...
	X? ( x11-libs/libX11
		x11-libs/libXt )
	alsa? ( >=media-libs/alsa-lib-1.0.20-r1 )
